...
def _retira_sobrants(
    ...
    *, altres_lligues: bool = True,
    ...
    Sempre, les files d'aquesta lliga que ja no surten al que hem publicat: són
    les que han canviat de nom. I, si `altres_lligues`, també les temporades
    anteriors, que ja tenen el seu lloc a l'històric —això només val per a les
